// Professional Orders Management System - Backend Integration
class OrdersManager {
    constructor() {
      this.orders = []
      this.currentOrders = []
    ...
    getEstimatedTime(status) {
      const times = {
        placed: "Processing",
        accepted: "20-25 mins",
        dispatched: "15-20 mins",
        confirmed: "10-15 mins",
        delivered: "Delivered",
        completed: "Completed",
        cancelled: "Cancelled",
        rejected: "Rejected",
    ...
    getProgressPercentage(status) {
      // Updated progression: accepted → dispatched → confirmed → delivered
      const progress = {
        placed: 10,
        accepted: 25,
        dispatched: 50,
              ...
              <div class="order-card" onclick="openOrderModal('${order.id}')">
                  <div class="order-header">
                      ...
                      <div class="order-status">
                          <div class="status-badge ${order.order_status}" id="status-${order.id}">
                  ...
                  ${showProgress && ["accepted", "dispatched", "confirmed", "delivered"].includes(order.order_status) ? this.renderProgressIndicator(order) : ""}
                  ...
                  <div class="order-actions" onclick="event.stopPropagation()">
                      ...
                      ${
                        !isRecent && ["placed", "accepted"].includes(order.order_status)
                          ? `
    ...
    renderProgressIndicator(order) {
      // Updated progression: accepted → dispatched → confirmed → delivered
      const steps = ["accepted", "dispatched", "confirmed", "delivered"]
  ...
  function openOrderModal(orderId) {
    ...
    modalBody.innerHTML = `
          <div class="order-details">
              ...
              <!-- Order Items -->
              <div class="detail-section">
                  <h4><i class="fas fa-shopping-bag"></i> Items (${order.items.length})</h4>
                        ...
                        .map(
                          ...
                          <div class="order-item-detail">
                              ...
                              <div class="item-detail-info">
                                  ...
                                  <div class="item-detail-quantity">Qty: ${item.quantity}</div>
                              </div>
              ...
              <div class="detail-section">
                  ...
                  <div class="detail-row" style="border-top: 1px solid #e9ecef; padding-top: 0.5rem; margin-top: 0.5rem; font-weight: 700;">
                      <span class="detail-label">Total:</span>
                      <span class="detail-value" style="color: #28a745;">₹${order.total_amount.toFixed(2)}</span>
                  </div>
              </div>
              ...
              ${
                order.notes
                  ...
                  <div class="detail-section">
                      ...
                      <p style="margin: 0; color: #666; font-size: 0.9rem;">${order.notes}</p>
                  </div>
              `
                  : ""
              }
  ...
  function downloadBill(orderId) {
    ...
    a.href = url
    a.download = `SnackMart_Bill_${order.razorpay_order_id}.html`
    document.body.appendChild(a)
    a.click()
    document.body.removeChild(a)
    window.URL.revokeObjectURL(url)
  
    ordersManager.showNotification("Bill downloaded successfully", "success")
  }
  ...
  <head>
      ...
      <title>Bill - ${order.razorpay_order_id}</title>
      <style>
          * {
              margin: 0;
              padding: 0;
  ...
  function openPincodeModal() {
    console.log("Pincode modal opened")
  }
  
  function closePincodeModal() {
    console.log("Pincode modal closed")
  }
