/**
 * Admin Dashboard
 * Enhanced with proper data fetching and section switching
 */
...
const CONFIG = {
    ...
    const demoOrders = [
      {
        ...
        order_status: "placed",
        items: [
          { name: "Organic Almonds", variant: "500g", quantity: 2, price: 450, originalPrice: 500 },
          { name: "Honey", variant: "250g", quantity: 1, price: 350, originalPrice: 400 },
        ],
        address: {
      ...
      },
      {
        ...
        items: [{ name: "Organic Rice", variant: "1kg", quantity: 1, price: 850, originalPrice: 900 }],
        address: {
      ...
      },
      {
        ...
        items: [{ name: "Mixed Nuts", variant: "500g", quantity: 3, price: 700, originalPrice: 750 }],
        address: {
  ...
  function updateTabCounts() {
    ...
    const counts = {
      ...
      accepted: state.allOrders.filter((order) => order.order_status === "accepted").length,
